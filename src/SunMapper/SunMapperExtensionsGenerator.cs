...
namespace SunMapper.Generated.Extensions
{
    ...
    {");
            ...
            {
                GenerateExtensionMethod(context, sb, classToMap, indent + indent);
        ...
        private void GenerateExtensionMethodBody(GeneratorExecutionContext context, StringBuilder sb, MappingClassesInfo info, string indent)
        {
            ...
            sb.AppendLine($"{indent}{indent}destination = new()");
            ...
            foreach (var destinationClassProperty in destinationClassProperties)
            {
                ...
                {
                    sb.AppendLine($"{indent}{indent}{destinationClassProperty.Name} = source.{destinationClassProperty.Name},");
                }
            }
            sb.AppendLine($"{indent}{indent}}};");
            sb.AppendLine($"{indent}{indent}return true;");
            sb.AppendLine($"{indent}}};");
            sb.AppendLine($"{indent}catch(Exception ex) {{");
            sb.AppendLine($"{indent}{indent}return false;");
            sb.AppendLine($"{indent}}};");
        }
